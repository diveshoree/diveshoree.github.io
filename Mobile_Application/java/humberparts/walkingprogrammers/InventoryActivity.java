...
public class InventoryActivity extends AppCompatActivity {
    ...
    private ModelInventory dbInventory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference inventory = mFirebaseDb.getReference("inventory");
        inventory.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                dbInventory = dataSnapshot.getValue(ModelInventory.class);

                for (ModelInventory item : dbInventory.getParts()) {
                    mInventory.add(item);
                }
