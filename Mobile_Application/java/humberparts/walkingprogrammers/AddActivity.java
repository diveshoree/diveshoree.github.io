...
public class AddActivity extends AppCompatActivity {
    ...
    private DatabaseReference mDatabase,cData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cData = FirebaseDatabase.getInstance().getReference();
            ...
            case R.id.buttonadd1:
                if(student_id.length() == 0){
                    ...
                    if (isAdded) {
                        ...
                        cData.child("inventory").child("parts").orderByChild(part1.getText().toString());
                        cData.keepSynced(true);
                        cData.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                id--;
                                cData.child("inventory").child("parts").child(part1.getText().toString()).child("in stock").setValue(id);
                            }
